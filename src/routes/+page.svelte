...
<svelte:head>
  ...
  <meta name="twitter:title" content="Niag Alves | Início">
  <meta name="twitter:description" content="Um breve resumo sobre minha carreira profissional na área de desenvolvimento web.">
  ...
  <meta property="og:site_name" content="Niag Alves | Início" />

  <title>Niag Alves | Início</title>
</svelte:head>
